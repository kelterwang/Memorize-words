...
完整版 APK 内置 Kokoro，美音 Heart / 英音 Emma 均可离线使用，首次打开自动准备，无需另外下载或导入 ZIP。“我的”中选择手机自带发音或 Kokoro，两种来源均为 1 倍速。手机发音兼容仅提供通用英文或旧式语言接口的引擎；没有可用英文服务或播放失败时自动改用内置 Kokoro，并显示实际来源。
