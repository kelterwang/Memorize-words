...
- Kokoro v1.0: https://huggingface.co/hexgrad/Kokoro-82M (Apache-2.0, see Kokoro-LICENSE). Converted model and voice table: https://github.com/k2-fsa/sherpa-onnx/releases/tag/tts-models . Included in the separate voice ZIP, not the APK.
